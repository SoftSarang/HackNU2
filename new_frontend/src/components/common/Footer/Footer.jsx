    ...
    <FooterContainer as={motion.footer} initial="hidden" animate="visible" variants={motionVariants}>
      <FooterInner>
        ...
        <Social aria-label="social-links">
          <a href="https://t.me/iitu_bignews" title="Telegram" target="_blank" rel="noreferrer">
          ...
          <a href="https://www.instagram.com/yernur.developer/" title="Instagram" target="_blank" rel="noreferrer">
